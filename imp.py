...
# 敵のセット位置
STAGE_EM_POS = [            # 時間, X, Y, id0, id1

#    [ 100, 128,   0, EMBOSS,  0,],   # Boss

    [ 200,  128-60,   0,  EM2,  0,],    # まっすぐ
    [ 240,  128-60,   0,  EM2,  0,],
    [ 280,  128-60,   0,  EM2,  0,],
    ...
    [1750,  128-40,   0,  EM0,  0,],    # 撃ってもどる
    [1800,  128+40,   0,  EM0,  0,],

    [1900,  128-00,   0,  EM0,  2,],    # 全方向撃って戻る
    [2300,  128-40,   0,  EM0,  2,],    # 全方向撃って戻る
    [2700,  128+40,   0,  EM0,  2,],    # 全方向撃って戻る

    [3500, 128,   0, EMBOSS,  0,],   # Boss
